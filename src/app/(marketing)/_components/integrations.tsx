...
export default function ShiprIntegrations() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-6">
        ...
        <div className="mx-auto mt-12 max-w-md text-balance text-center">
          ...
          <p className="text-muted-foreground mb-6 mt-4">
            Shipr connects with the services you already use. Authentication,
            database, payments, and deployment -- all pre-configured.
          </p>
          <Button
            variant="secondary"
            size="sm"
