      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              website to function properly, including authentication and
              security features provided by Clerk.
            </li>
            <li>
              <strong>Analytics Cookies:</strong> We use these to understand how
              visitors interact with our website, helping us improve our
              service.
            </li>
            <li>
              <strong>Preference Cookies:</strong> These remember your settings
              and preferences, such as theme selection and language preferences.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              Clerk uses cookies to maintain your login session and security.
            </li>
            <li>
              <strong>Vercel:</strong> Our hosting provider uses cookies for
              analytics and performance monitoring.
            </li>
          </ul>
          <p>
            These third-party services have their own cookie policies, which we
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p>
                ...
                them. They help us remember your preferences and provide a
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            to websites that you do not want to have your online activity
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            any material changes by posting the updated policy on this page with
